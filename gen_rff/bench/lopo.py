"""gen_rff.bench.lopo — LOPO splits + pairwise matrix + baseline reproduction (P0-G1).
...
All under gen_rff.bench.harness (the ported §4.3 harness).
"""
import os
import sys
import re
...
from ..data import loaders, registry
...
def _classical(Xt):
    from ..physics.features import classical_matrix
