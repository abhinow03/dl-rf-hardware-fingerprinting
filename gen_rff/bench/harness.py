"""gen_rff.bench.harness — THE locked scoring harness (EVAL_PROTOCOL §4.3), ported verbatim.

Metric primitives are COPIED from results/step7_test_and_harness/test_and_harness.py (which
cannot be imported — it runs heavy code at module import). `score_locked` / `hdbscan_pred`
are imported from the import-safe results/step2_integrity/integrity.py.
...
from integrity import score_locked, hdbscan_pred, unitrows, bursts_coherent   # noqa: F401
