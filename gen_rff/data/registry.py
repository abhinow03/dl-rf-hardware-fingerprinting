"""gen_rff.data.registry — the DOMAIN REGISTRY (single source of truth).
...
REGISTRY = {
    "WISIG": Domain(
        ...
        path="~/CAPSTONE/phase3_dataset/ManyTx.pkl", loader_fn=loaders.load_wisig,
    ...
    "DRFF": Domain(
        ...
        path="~/Desktop/processed/drff_r2", loader_fn=loaders.load_drff_native,
    ...
    "ORACLE": Domain(
        ...
        window_len=4096, n_fft=256, hop=64,
        path="~/Desktop/neu_m044q5210./KRI-16Devices-RawData", loader_fn=loaders.load_oracle,
