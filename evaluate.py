# evaluate.py — Phase 7 Evaluation
# 1. Extract embeddings for all 16 devices x all distances
# 2. t-SNE coloured by device
# 3. t-SNE coloured by distance
# 4. Held-out cluster purity
...
OUTPUT_DIR  = os.path.expanduser("~/phase7_output_v4")
