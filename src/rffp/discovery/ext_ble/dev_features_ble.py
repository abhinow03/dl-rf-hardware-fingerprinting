...
from rffp.discovery.ext_ble.features_ble_classical import extract, FEATURE_NAMES, FAMILY

ROOT="/home/docker/pw26_akp_01/ext_data/ble_xiao"
OUT="/home/pw26_akp_01/CAPSTONE/DL_model/gen_rff/ext_protocols/audit_out"
SP=json.load(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "splits_ext_ble.json")))
