"""rffp.evaluation.inference — Phase-1 open-set inference pipeline.

Open-set RF emitter discovery on held-out ORACLE devices via DBSCAN + cosine-similarity
registry matching (enroll known devices, flag/cluster unknowns).

    python3 -m rffp.evaluation.inference --demo
...
OUTPUT_DIR  = os.path.expanduser(os.environ.get("RFFP_ORACLE_OUT", "~/phase8_output"))
